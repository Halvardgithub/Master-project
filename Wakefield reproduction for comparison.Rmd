...
mod_eval_W <- function(df, mean = "", V = "", P, tau = "") {
  ...
  for(i in 1:n){#iterate over each simulated realization
    ...
    #Saving the fits
     save(res_RW1, file=paste0("C:/Users/Halvard/Documents/GitHub/Master-project/Wakefield-data/PC/Fits_W/RW1/fit_W_", mean, "_", P, "_", tau, "_", i))
     save(res_ARW1, file=paste0("C:/Users/Halvard/Documents/GitHub/Master-project/Wakefield-data/PC/Fits_W/ARW1/fit_W_", mean, "_", P, "_", tau, "_", i))
  }
  save(eval_df, file=paste0("C:/Users/Halvard/Documents/GitHub/Master-project/Wakefield-data/PC/Results_W/eval_df_", mean, "_", P, "_", tau))
...
plot <- ggarrange(f_75_CT$RMSE, f_150_CT$RMSE, f_300_CT$RMSE,
                                 d_75_CT$RMSE, d_150_CT$RMSE, d_300_CT$RMSE,
                                 t_75_CT$RMSE, t_150_CT$RMSE, t_300_CT$RMSE,
                                 ncol = 3, nrow = 3)
plot_eval_CT_W_RMSE <- annotate_figure(plot, 
                top = text_grob("RMSE for Wakefield data with constant tau"))
#save(plot_eval_CT_W_RMSE, 
 #   file = "C:/Users/Halvard/Documents/GitHub/Master-project/Plot_W_n20_v2/plot_eval_CT_W_RMSE")

plot <- ggarrange(f_75_CT$LS, f_150_CT$LS, f_300_CT$LS,
                               d_75_CT$LS, d_150_CT$LS, d_300_CT$LS,
                               t_75_CT$LS, t_150_CT$LS, t_300_CT$LS, 
                               ncol = 3, nrow = 3)
plot_eval_CT_W_LS <- annotate_figure(plot, 
                top = text_grob("LS for Wakefield data with constant tau")) 
#save(plot_eval_CT_W_LS, 
 #   file = "C:/Users/Halvard/Documents/GitHub/Master-project/Plot_W_n20_v2/plot_eval_CT_W_LS")
...
#Making the 3x3 boxplots
plot <- ggarrange(f_75_NCT$RMSE, f_150_NCT$RMSE, f_300_NCT$RMSE,
                                d_75_NCT$RMSE, d_150_NCT$RMSE, d_300_NCT$RMSE,
                                t_75_NCT$RMSE, t_150_NCT$RMSE, t_300_NCT$RMSE, 
                                ncol = 3, nrow = 3)
plot_eval_NCT_W_RMSE <- annotate_figure(plot, 
                top = text_grob("RMSE for Wakefield data with non-constant tau")) 
#save(plot_eval_NCT_W_RMSE, 
 #   file = "C:/Users/Halvard/Documents/GitHub/Master-project/Plot_W_n20_v2/plot_eval_NCT_W_RMSE")



plot <- ggarrange(f_75_NCT$LS, f_150_NCT$LS, f_300_NCT$LS,
                                d_75_NCT$LS, d_150_NCT$LS, d_300_NCT$LS,
                                t_75_NCT$LS, t_150_NCT$LS, t_300_NCT$LS, 
                                ncol = 3, nrow = 3)
plot_eval_NCT_W_LS <- annotate_figure(plot, 
                top = text_grob("LS for Wakefield data with non-constant tau"))
#save(plot_eval_NCT_W_LS, 
 #   file = "C:/Users/Halvard/Documents/GitHub/Master-project/Plot_W_n20_v2/plot_eval_NCT_W_LS")
```
...
for(m in 1:length(means)){
  for(p in 1:length(precs)){
    for(t in 1:length(taus)){
      load(paste0("C:/Users/Halvard/Documents/GitHub/Master-project/Wakefield-data/Gamma0,005/Results_W/eval_df_", means[m], "_", precs[p], "_", taus[t]))
...
save(full_eval_df, file="C:/Users/Halvard/Documents/GitHub/Master-project/Wakefield-data/Gamma0,005/Results_W/full_eval_df")
```
...
make_full_box_plot <- function(df, criteria, tau){
  ...
  if(tau == "CT"){title <- paste0(title, "constant tau")}
  else{title <- paste0(title, "non-constant tau")}
  
  plot_w_title <- annotate_figure(plot, top = text_grob(title))
  #use ggsave and return the plot aswell??
  return(plot_w_title)
}
```
...
make_full_box_plot(full_eval_df, "RMSE", "CT")
make_full_box_plot(full_eval_df, "LS", "CT")
make_full_box_plot(full_eval_df, "RMSE", "NCT")
make_full_box_plot(full_eval_df, "LS", "NCT")

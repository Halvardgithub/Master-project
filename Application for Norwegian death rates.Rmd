...
prior_str <- "Gamma0,005" # alternatives are Gamma0,005 and Gamma0,00005 and PC
family <- "poisson"
...
#plotting
df <- cbind(DR20_24[, c("Year", "death_rate")], data.frame(eta = res_RW1$summary.fitted.values$mean, lower = res_RW1$summary.fitted.values$'0.025quant',
            upper = res_RW1$summary.fitted.values$'0.975quant'))
...
df <- cbind(DR20_24[, c("Year", "death_rate")], data.frame(eta = res_ARW1$summary.fitted.values$mean, lower = res_ARW1$summary.fitted.values$'0.025quant',
            upper = res_ARW1$summary.fitted.values$'0.975quant'))
...
df <- cbind(DR20_24[, c("Year", "death_rate")], data.frame(eta = res_ARW1_3tau$summary.fitted.values$mean, lower = res_ARW1_3tau$summary.fitted.values$'0.025quant',
            upper = res_ARW1_3tau$summary.fitted.values$'0.975quant'))
...
result_plot <- grid.arrange(plot_20_RW1, plot_20_ARW1, plot_20_ARW1_3tau, nrow = 3, top = textGrob("With a Gamma(1, 0.005) prior and a Poisson likelihood", gp = (gpar(fontsize = 15))))


#ggsave(paste0("C:/Users/Halvard/Documents/GitHub/Master-project/HMD-plots/", family, "_", prior_str, ".pdf"), plot = result_plot, height = 15, width = 8, units = "in")

#ggsave(paste0("C:/Users/Halvard/Documents/GitHub/Master-project/HMD-plots/", family, "_", prior_str, "_table.pdf"), plot = ss, height = 1.2, width = 3.5, units = "in")

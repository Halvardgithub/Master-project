...
prior_str <- "Gamma0,00005" # alternatives are Gamma0,005 and Gamma0,00005 and PC
family <- "nbinomial"
title <- "With a Gamma(1, 0.00005) prior and a negative binomial likelihood"
...
ggsave(paste0("C:/Users/Halvard/Documents/GitHub/Master-project/HMD-plots2/", family, "_", prior_str, ".pdf"), plot = result_plot, height = 15, width = 8, units = "in")

ggsave(paste0("C:/Users/Halvard/Documents/GitHub/Master-project/HMD-plots2/", family, "_", prior_str, "_table.pdf"), plot = ss, height = 1.2, width = 3.5, units = "in")
...
plot_20_RW1 <- ggplot(df, aes(Year)) + 
      ...
      labs(x = "Year", y = "y") +
      theme(legend.position = "none") +
      annotate("text", x = 1960, y = max(df$upper), label = "RW1",size = 5)
...
plot_20_ARW1 <- ggplot(df, aes(Year)) + 
      ...
      labs(x = "Year", y = "y") +
      theme(legend.position = "none") +
      annotate("text", x = 1960, y = max(df$upper), label = "ARW1",size = 5)
...
plot_20_ARW1_3tau <- ggplot(df, aes(Year)) + 
      ...
      labs(x = "Year", y = "y") +
      theme(legend.position = "none") + 
      annotate("text", x = 1960, y = max(df$upper), label = "ARW1_3tau",size = 5)
...
ggsave(paste0("C:/Users/Halvard/Documents/GitHub/Master-project/HMD-plots2/xPlot", family, "_", prior_str, ".pdf"), plot = result_plot2, height = 15, width = 8, units = "in")
```

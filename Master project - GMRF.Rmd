...
ggplot(df, aes(x=t)) + 
  geom_line(aes(y = X1)) + geom_line(aes(y = X2)) +
  geom_line(aes(y = X3)) + geom_line(aes(y = X4)) +
  geom_line(aes(y = X5)) + geom_line(aes(y = X6)) +
  geom_line(aes(y = X7)) + geom_line(aes(y = X8)) +
  geom_line(aes(y = X9)) + geom_line(aes(y = X10)) 
